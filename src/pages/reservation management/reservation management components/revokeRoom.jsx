...
function RevokeRoom({closeModal,roomId}) {
    ...
    const postdata1 = async () => {
        try {
            ...
            const roomInfo = await axios({
                url: `https://arr-dev.azurewebsites.net/api/v1/webs/bookings/reserved-timeslots`,
        ...
        <div>
            <div className="disable-model">
                <div className="disable-modelContainer">
                    ...
                    <h5>Reason</h5>
                    <textarea class="revoke-reason" onChange={onChangeReason}></textarea>
                    <div className="footer revoke-footer">
                        <button className="revoke-btn btn btn-danger btn-sm" onClick={onClickRevoke} type="button">Create</button>
                    </div>
                </div>
